    ...
    <div class="row">
		  <ul class="nav nav-tabs">
			...
			<li><a href="addanimal.php">Add Animal</a></li>
              <li  class="active"><a href="addThings.php">Add Things</a></li>
		...
		<div class="col-md-6">
			<div class="panel panel-default"  style="background-color: aliceblue;">
				<div class="panel-body">		
					<div class="row">
						<label class="col-md-3 lbltext">Favourite Things</label>
						<div class="col-md-3">
							<input type="text" class="col-sm-4 form-control" id="addField" placeholder="Favourite things">
					...
					<div class="row">
						<div class="col-md-4" style="text-align:center;margin-left: 67px; ">
							<input type="button" value="Submit" class="btn" onclick="validation('things')" style="margin-top: 31px;">
						</div> 
					</div>
				</div>
			</div>
